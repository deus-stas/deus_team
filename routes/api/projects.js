...
router.put("/projects/:id",
    upload.fields([
        ...
        var a = {
          ...
          const editedName = name.split('').map(char => a[char] || char).join('');
          const rmPercent = editedName.replace(/%/g, '');
          const editedWithLine = rmPercent.split(' ').join('-');
          project.nameInEng = editedWithLine.toLowerCase();
