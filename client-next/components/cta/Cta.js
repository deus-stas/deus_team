...
function CheckboxRegular(props) {
    return (
        <Field name={props.name}>
            {({ field, form }) => (
                <label className="form__checks-label_sogl">
                    <input
                        {...field}
                    ...
                    />
                    <div className="form__checks-c_sogl">
                        <div className="form__checks-text">
                            {props.text} <Link target="_blank" href="/privacy-policy">персональных данных</Link>
                        </div>
                    </div>
                </label>
            )}
        ...
        <section className="cta whiteHeader borderBlock">
                ...
                <div className="cta__wrap">
                    ...
                    <div className="cta__f">
                        <Formik
                            initialValues={{ name: '', company: '', phone: '', email: '', about: '', formFiles: [], ctaServices: [],pers:[], budget: '', formName: formName === 'tender' ? 'Тендер' : 'Хотите обсудить проект?' }}
                            validate={values => {
                                const errors = {};
                                ...
                                if (values.pers.length === 0) {
                                    errors.pers = 'Обязательное поле';
                                }
                                ...
                                <form className="form" onSubmit={handleSubmit}>
                                    <div className="form__inner" style={{display: success ? 'none' : 'block'}}>
                                        <input type="hidden" name="formName"
                                               value={formName === 'tender' ? 'Тендер' : 'Обсудить проект'}/>
                                        ...
                                        <div className="form__checks">
                                            ...
                                            <div className="form__checks-wrap m-text">
                                                <Checkbox name="ctaServices" value="Фирменный стиль"
                                                          text="Фирменный стиль"/>
                                                <Checkbox name="ctaServices" value="Сайты и сервисы"
                                                          text="Сайты и сервисы"/>
                                                <Checkbox name="ctaServices" value="Контент-маркетинг"
                                                          text="Контент-маркетинг"/>
                                                <Checkbox name="ctaServices" value="SEO-продвижение"
                                                          text="SEO-продвижение"/>
                                            </div>
                                            <div
                                                className="form__error check-error ">{errors.ctaServices && touched.ctaServices && errors.ctaServices}</div>
                                        </div>
                                        <div className="form__wrap m-text">
                                            <div
                                                className={`form__group ${errors.name && touched.name ? 'error' : ''}`}>
                                                {values.name && <label htmlFor="name" className="form__label xs-text">Ваше
                                                    имя</label>}
                                                <input type="text" name="name" className="form__input m-text"
                                            ...
                                            <div
                                                className={`form__group ${errors.company && touched.company ? 'error' : ''}`}>
                                                {values.company && <label htmlFor="company"
                                                                          className="form__label xs-text">Компания</label>}
                                                <input type="text" name="company" className="form__input m-text"
                                                       onChange={handleChange} value={values.company}
                                                       placeholder="Компания"/>
                                                <div
                                                    className="form__error">{errors.company && touched.company && errors.company}</div>
                                            </div>
                                        </div>
                                        <div className="form__wrap m-text">
                                            <div
                                                className={`form__group ${errors.phone && touched.phone ? 'error' : ''}`}>
                                                {values.phone && <label htmlFor="phone" className="form__label xs-text">Номер
                                                    телефона</label>}
                                                <PhoneInput type="text" name="phone" className="form__input m-text"
                                                            onInput={handleInput} onKeyDown={handleKeyDown}
                                                            onChange={handleChange} value={values.phone}
                                                            setFieldValue={setFieldValue} placeholder="Номер телефона"
                                                            mask="+7 (999) 999-99-99"/>
                                                <div
                                                    className="form__error">{errors.phone && touched.phone && errors.phone}</div>
                                            </div>
                                            <div
                                                className={`form__group ${errors.email && touched.email ? 'error' : ''}`}>
                                                {values.email && <label htmlFor="email"
                                                                        className="form__label xs-text">E-mail</label>}
                                                <input type="text" name="email" className="form__input m-text"
                                        ...
                                        <div className="form__wrap m-text">
                                            ...
                                            <div
                                                ...
                                                {values.about &&
                                                    <label htmlFor="about" className="form__label xs-text">О
                                                        себе</label>}
                                        ...
                                        <div className="form__checks soglasie">
                                            <CheckboxRegular name="pers" value="Согласие" text="Согласие на обработку "/>
                                            <div
                                                className="form__error check-error ">{errors.pers && touched.pers && errors.pers}</div>
                                        </div>
