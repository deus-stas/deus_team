...
const Agency = (props) => {
    ...
    const sizeLarge = 'Мы — студия графического и веб-дизайна, действующая с 2016 года. В рамках нашей группы компаний работают студия no-code разработки <a href="https://praktika.digital/" target="_blank" ><span data-hover="Praktika">Praktika</span></a>,  видеопродакшн <a href="https://redtape.team/" target="_blank" ><span data-hover="Redtape">Redtape</span></a>  рекламное агентство <a href="https://adspotter.ru/"  target="_blank"><span data-hover="Adspotter">Adspotter</span></a>, что позволяет нам предлагать комплексные решения для наших клиентов.'
                            ...
                            <div className="agency-principle__wrapp">
                                <div className="agency-principle__wrap-item">
                                    ...
                                    <span className="flex-wrap">
                                        ...
                                        <p className={principleText}>Мы ценим силу честного слова. Неважно, как оформлена договоренность — свои обязательства мы выполняем. Без исключений.</p>
                                    </span>
                                </div>
                                <div className="agency-principle__wrap-item">
                                    ...
                                    <p className="text l-textMed">Доверие и ответственность</p>
                                        <p className={principleText}>Наши отношения с клиентами строятся на взаимном доверии. Мы гарантируем результат и отвечаем за него.</p>
                                    </span>
                                ...
                                <div className="agency-principle__wrap-item">
                                    ...
                                    <span className="flex-wrap">
                                        ...
                                        <p className={principleText}>Для нас недопустимы успехи, достигнутые в обход этических принципов. Чистая репутация дороже сиюминутной выгоды.</p>
                                    </span>
                                </div>
                    ...
                    <section id="agency" className="agency-team borderBlock">
                        <div className="agency-team__wrap">
                            <div className="intro">
                                ...
                                <p className="descr m-text">Мы ценим профессионализм, ответственность и умение работать в команде, где каждый участник не просто выполняет задачи, а вносит вклад в общий результат. Для нас важны не только навыки, но и способность мыслить стратегически, принимать решения и брать на себя ответственность.</p>
                            </div>
