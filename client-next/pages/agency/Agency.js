...
const Agency = (props) => {
    ...
    const sizeLarge = 'Мы не делим проекты на «большие» <br> и «маленькие» — для нас ценен каждый запрос. <br> Создавая решения для компаний, становимся <br> их стратегическими партнерами: помогаем быстро <br> масштабироваться, находим нестандартные <br> ходы и бережно растим их идеи.'
