                ...
                <main className="service container">
                        ...
                        <section className="services-detail-start">
                            ...
                            <div className="services-about__wrap">
                                ...
                                <div className="services-detail-start__content">
                                    <p className="services-detail-start__text"
                                       dangerouslySetInnerHTML={{__html: service.description || ""}}/>
                                    <Link href={`/contacts`} className="services-detail-start__btn">Расчитать
                                        стоимость</Link>
                                </div>
                            </div>
                        </section>
                    ...
                    {service && service.serviceBanner &&
                        <section className="services-detail-banner">
                            <img className="services-detail-banner__img"
                                 src={`${apiUrl}/${service.serviceBanner.path}`}/>
                        </section>
                            ...
                            <div className="services-detail-aspro__wrap">
                                <div className="services-detail-aspro__title">
                                    <h2 className="heading-secondary"
                                        dangerouslySetInnerHTML={{__html: service.asproTemplatesTitle}}/>
                                    <p className="services-detail-aspro__subtitle"
                                       dangerouslySetInnerHTML={{__html: service.asproTemplatesDescription}}/>
                                </div>
                                    ...
                                    {service.asproTemplatesOptions &&
                                        ...
                                        service.asproTemplatesOptions.map ((item, index) => (
                                            <div className="services-detail-aspro__wrap-item"
                                                 key={`services-detail-aspro__wrap-item-${index}`}>
                                                <p className="num">0{++index}</p>
                                                <span className="flex-wrap">
                                                        <p className="text l-textMed"
                            ...
                            <div className="services-detail-type__wrap">
                                <div className="services-detail-type__title">
                                    <div>
                                        ...
                                        <p className="services-detail-aspro__subtitle s-text"
                                           dangerouslySetInnerHTML={{__html: service.serviceIncludesDescription}}/>
                                    ...
                                    {service.serviceIncludesOptions &&
                                        ...
                                        service.serviceIncludesOptions.map ((item, index) => (
                                            <div className="services-detail-type__item type-item"
                                                 key={`services-detail-type__item-${index}`}>
                                                <div className="type-item__title"
                                                     dangerouslySetInnerHTML={{__html: item.title}}/>
                                                <div className="type-item__bottom">
                                                    <div className="type-item__subtitle"
                                                         dangerouslySetInnerHTML={{__html: item.description}}/>
                                                </div>
                                            </div>
                                        ))}
                                        ...
                                        Array.isArray (service.serviceIncludesOptions) && (
                                            <Swiper
                                                ...
                                                breakpoints={{
                                                    320: {
                                                        slidesPerView: 1.3,
                                                        autoHeight: true, // ✅ Автовысота работает и для нескольких слайдов
                                                    },
                                                    768: {
                                                        slidesPerView: 2.3,
                                                        autoHeight: true, // ✅ Автовысота работает и для нескольких слайдов
                                    ...
                                    <div className="describe">
                                        <div className="describe__top">
                                            ...
                                            <div className="describe__wrapp ">
                                                <p className="s-text">
                                                    Объединяем аналитику, маркетинг, дизайн, разработку и
                                                    интеграции в единую систему для получения максимальной
                                                    эффективности для вашего бизнеса
                                                </p>
                                            </div>
                                        </div>
                                        <Link href={`/contacts`} className="services-form__btn --accent">Расчитать
                                        ...
                                        {!!service.tariffs && service.tariffs.map ((tariffs, index) => {
                                            ...
                                            return (
                                                <div className="describe__wrapp-benefits__item"
                                                     key={`$describe__wrapp-benefits-key-${index}`}>
                        ...
                        <section className="services-detail-faq">
                            <div className="services-detail-faq__wrap faq-wrap">
                                <div className="faq-wrap__info">
                                    ...
                                    <div className="faq-wrap__subtitle">Если вы не нашли ответ на ваш вопрос напишите
                                        нашему руководителю и он на них ответит
                                    </div>
                                    {Array.isArray (team) &&
                                        team
                    ...
                    {service &&
                        ...
                        <section className="services-detail-why-us">
                            <div className="services-detail-why-us__wrap why-us padding borderBlock">
                                <h2 className="heading-secondary"
                                    dangerouslySetInnerHTML={{__html: service.whyChooseUsTitle}}/>
                                        ...
                                        return (
                                            <div className={`main-clients__marquee-agency`} key={`row-${count}`}>
                                                <div className="marquee-container-agency">
                                                    <Marquee speed={40} loop={0} style={{overflow: 'hidden'}}
                                                             gradient={false}
                                                             direction={count % 2 === 0 ? "right" : 'left'}>
                                                        {row.map ((client, i) => (
                                                            <div className='agency-clients__img marquee-item'
                                                                 key={client.id || i}>
                                        ...
                                        return (
                                            <div className="article__item" key={index}>
                                                <Link href={`/blog/${item.urlName}`}
                                                      className={`news-main__item news-main__${index + 1}`}
                                                      key={item.id}>
                                                    {isVideo && <video autoPlay={shouldAutoPlay}
                                                                       ...
                                                                       loop/>}
                                                    {isImage &&
                                                        <img width="300" height='200' src={fileUrl} alt={item.name}/>}
                                                </Link>
                                                <span>
                                                    ...
                                                    <div className="article__item">
                                                        <Link href={`/blog/${item.urlName}`}
                                                            ...
                                                            {isVideo && <video autoPlay={shouldAutoPlay}
                                                                               ...
                                                                               src={fileUrl}
                                                                               loop/>}
                                                            {isImage && <img width="300" height='200' src={fileUrl}
                                                                             alt={item.name}/>}
                                                        </Link>
                                                        <span>
                                                  <p className="article__subtitle s-text">{item.newsTags}</p>
