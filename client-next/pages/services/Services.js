...
const Services = () => {
    ...
    const sizeLarge = 'Мы не делим проекты на «большие»\n' +
        'и «маленькие» — для нас ценен каждый запрос.\n' +
        'Создавая решения для компаний, становимся\n' +
        'их стратегическими партнерами: помогаем быстро\n' +
        'масштабироваться, находим нестандартные\n' +
        'ходы и бережно растим их идеи.'
