        ...
        <section className="cta whiteHeader borderBlock">
                ...
                <div className="cta__wrap">
                    <div>
                        ...
                        <p style={{color: '#E0FD60', marginBottom:'1rem'}} className="l-textReg hover-flip"><Link className="hoverMail"
                                                                         to="mailto:hello@de-us.ru"><span
                            data-hover="hello@de-us.ru">hello@de-us.ru</span></Link></p>
