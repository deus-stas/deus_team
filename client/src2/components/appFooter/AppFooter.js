                ...
                <div className="footer__wrap">
                    ...
                    <div className="footer__item hidden-mobile">
                        ...
                        {/* <a className='btn' href={`${apiUrl}/uploads/DEUS.pdf`}>Скачать презентацию</a> */}
                        {
                            ...
                            <a href={`${apiUrl}/uploads/${headerData.presentation.filename}`} target='_blank'  className="btn">Скачать презентацию</a> :
                            <a href={`${apiUrl}/uploads/DEUS.pdf`} target='_blank'  className="btn">Скачать презентацию</a>
                        }
                    </div>
